	...
	public PanelBajaEmpleados() {
		...
		btnBuscar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if ( !"".equals(dniEmpleado) ) {
					...
					controladorAplicacion.handleRequest(IDEventos.EVENTO_CONSULTAR_EMPLEADOS_V_BORRAR, dniEmpleado);
				}
				else {
		...
		btnBorrarCliente.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if ( empleado != null )
					ControladorAplicacion.getInstance().handleRequest(IDEventos.EVENTO_BAJA_EMPLEADO, empleado.getDNI());
				else
		...
		if ( IDEventos.EVENTO_BAJA_EMPLEADO == idEvento ) {
			...
			if ( datos instanceof Boolean ) {
				...
				if ( correcto ) {
					...
					JOptionPane.showMessageDialog(contentPane, "El empleado no se ha borrado correctamente", "Error", JOptionPane.ERROR_MESSAGE);
				}
			}
		}
