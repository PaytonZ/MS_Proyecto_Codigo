...
public class GUIEmpleadosImp {
	...
	public FrameBajaTareaEmpleados getFrameBajaTareaEmpleados() {
		// begin-user-code
		return frameBajaTareaEmpleados;
		// end-user-code
	}
	...
	public void setFrameBajaTareaEmpleados(
		...
		// begin-user-code
		this.frameBajaTareaEmpleados = frameBajaTareaEmpleados;
		// end-user-code
	}
	...
	public FrameAltaTareaEmpleados getFrameAltaTareaEmpleados() {
		// begin-user-code
		return frameAltaTareaEmpleados;
		// end-user-code
	}
	...
	public void setFrameAltaTareaEmpleados(
		...
		// begin-user-code
		this.frameAltaTareaEmpleados = frameAltaTareaEmpleados;
		// end-user-code
	}
	...
	public void setFrameBajaEmpleados(FrameBajaEmpleados frameBajaEmpleados) {
		// begin-user-code
		this.frameBajaEmpleados = frameBajaEmpleados;
		// end-user-code
	}
	...
	public FrameConsultaMultipleEmpleados getFrameConsultaMultipleEmpleados() {
		// begin-user-code
		return frameConsultaMultipleEmpleados;
		// end-user-code
	}
	...
	public void setFrameConsultaMultipleEmpleados(
		...
		// begin-user-code
		this.frameConsultaMultipleEmpleados = frameConsultaMultipleEmpleados;
		// end-user-code
	}
	...
	public FrameModificacionEmpleados getFrameModificacionEmpleados() {
		// begin-user-code
		return frameModificacionEmpleados;
		// end-user-code
	}
	...
	public void setFrameModificacionEmpleados(
		...
		// begin-user-code
		this.frameModificacionEmpleados = frameModificacionEmpleados;
		// end-user-code
	}
	...
	public void setFrameConsultaEmpleados(
		...
		// begin-user-code
		this.frameConsultaEmpleados = frameConsultaEmpleados;
		// end-user-code
	}
	...
	public void setFrameAltaEmpleados(FrameAltaEmpleados frameAltaEmpleados) {
		// begin-user-code
		this.frameAltaEmpleados = frameAltaEmpleados;
		// end-user-code
	}
