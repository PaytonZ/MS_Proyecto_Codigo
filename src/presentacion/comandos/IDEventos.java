...
public enum IDEventos {
	...
	EVENTO_CONSULTAR_CLIENTE_RESERVAS, ERROR_CONSULTAR_CLIENTE_RESERVAS,
	EVENTO_CONSULTAR_CLIENTE_MODIFICAR_RESERVAS, ERROR_CONSULTAR_CLIENTE_MODIFICAR_RESERVAS,
