 ...
 */
public class CommandRConsultarTareasVBorrar implements Command {
	...
	public CommandResponse execute(Object datos) {
		...
		if ( cr.getEvento().equals(IDEventos.ERROR_CONSULTAR_TAREA) ) {
			...
			cr.setEvento(IDEventos.ERROR_CONSULTAR_TAREAS_V_BORRAR);
		}
		else {
			
			cr.setEvento(IDEventos.EVENTO_CONSULTAR_TAREAS_V_BORRAR);
		}
