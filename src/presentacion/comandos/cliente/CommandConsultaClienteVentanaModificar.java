...
public class CommandConsultaClienteVentanaModificar implements Command {
	...
	public CommandResponse execute(Object datos) {
		...
		try {
			...
			cr.setDatos(cliente);
			cr.setEvento(IDEventos.EVENTO_CONSULTAR_CLIENTE_V_MODIFICAR);

		} catch (BSoDException bsod) {

			cr.setDatos(bsod);
			cr.setEvento(IDEventos.ERROR_CONSULTAR_CLIENTE_V_MODIFICAR);
		}
