 ...
 */
public class CommandRConsultarDepartamentoVModificar implements Command {
	...
	public CommandResponse execute(Object datos) {
		...
		if ( cr.getEvento().equals(IDEventos.ERROR_CONSULTAR_DEPARTAMENTO) ) {
			...
			cr.setEvento(IDEventos.ERROR_CONSULTAR_DEPARTAMENTO_V_MODIFICAR);
		}
		else {
			
			cr.setEvento(IDEventos.EVENTO_CONSULTAR_DEPARTAMENTO_V_MODIFICAR);
		}
