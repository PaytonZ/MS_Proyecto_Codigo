...
public class CommandConsultaHabitacionVentanaBaja implements Command {
	...
	public CommandResponse execute(Object datos) {
		...
		try {
			...
			cr.setEvento(IDEventos.EVENTO_CONSULTAR_HABITACION_V_BAJA);

		} catch (BSoDException bsod) {

			cr.setDatos(bsod);
			cr.setEvento(IDEventos.ERROR_CONSULTAR_HABITACION_V_BAJA);
		}
