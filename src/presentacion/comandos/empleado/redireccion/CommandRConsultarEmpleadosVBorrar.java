 ...
 */
public class CommandRConsultarEmpleadosVBorrar implements Command{
	...
	public CommandResponse execute(Object datos) {
		...
		if ( cr.getEvento().equals(IDEventos.ERROR_CONSULTAR_EMPLEADO) ) {
			...
			cr.setEvento(IDEventos.ERROR_CONSULTAR_EMPLEADOS_V_BORRAR);
		}
		else {
			
			cr.setEvento(IDEventos.EVENTO_CONSULTAR_EMPLEADOS_V_BORRAR);
		}
