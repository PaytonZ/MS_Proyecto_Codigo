 ...
 */
public class PanelBajaDepartamentos extends JPanel implements
	GUIPanelesInterfaz {
	...
	btnBuscar.addActionListener(new ActionListener() {
		...
		if (!"".equals(nombreDepartamento)) {
		    ...
		    controladorAplicacion.handleRequest(
			    IDEventos.EVENTO_CONSULTAR_DEPARTAMENTO_V_BORRAR,
			    nombreDepartamento);
		} else {
		    JOptionPane.showMessageDialog(contentPane,
			    "El campo nombre no puede ser vacío", "Aviso",
	...
	btnBorrarCliente.addActionListener(new ActionListener() {
		...
		if (idDepartamento != null)
		    ...
		    JOptionPane
			    .showMessageDialog(
				    contentPane,
				    "Error al cargar el departamento, búsquelo otra vez",
	...
	if (IDEventos.EVENTO_BAJA_DEPARTAMENTO == idEvento) {
		...
		if (correcto) {
		    ...
		    JOptionPane.showMessageDialog(contentPane,
			    "El departamento se ha borrado correctamente",
		    ...
		    JOptionPane
			    .showMessageDialog(
				    contentPane,
				    "El departamento no se ha borrado correctamente, compruebe que no tiene empleados",
				    "Error", JOptionPane.ERROR_MESSAGE);
		}
	    }
	} else if (IDEventos.EVENTO_CONSULTAR_DEPARTAMENTO_V_BORRAR == idEvento) {
	...
	} else if (IDEventos.ERROR_BAJA_DEPARTAMENTO == idEvento
		|| IDEventos.ERROR_CONSULTAR_DEPARTAMENTO_V_BORRAR == idEvento) {
